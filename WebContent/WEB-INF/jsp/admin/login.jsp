...
<%@page import="project001.admin.impl.AdminDaoImpl" %>
<%@page import="java.util.*" %>
<%@page import="project001.admin.entity.Admin" %>
<%@page import="project001.util.Md5" %>
<%
	Admin a = (Admin)session.getAttribute("adminInfo");
	if(a != null){
		response.sendRedirect("/project001/admin");
		return ;
	}
	...
	if(action != null && action.equals("login")){
		...
		List<Admin> list = AdminDaoImpl.check(userName);
		Iterator it = list.iterator();
		if(it.hasNext()){
			Admin admin = (Admin)it.next();
			if(admin.getPassword().equals(Md5.pdwMD5(password))){
...
<html>
  <head>
	...
	<link rel="stylesheet" href="${staticPath}/css/sccl.css">
  ...
  <body class="login-bg">
    <div class="login-box">
        ...
        <div class="login-main">
			<form action="iLogin" class="layui-form" method="post">
