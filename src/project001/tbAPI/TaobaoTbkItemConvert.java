...
public class TaobaoTbkItemConvert {
    ...
    private static final String appKey = "24569060"; // 可替换为您的沙箱环境应用的appKey
    private static final String appSecret = "7e6506eff2e094b381a2a069288b228a"; // 可替换为您的沙箱环境应用的appSecret
    private static final String sessionKey = ""; // 必须替换为沙箱账号授权得到的真实有效sessionKey
 
    public static void main(String[] args) throws Exception {
        //System.out.println(getTbkItem());
    }
 
    public static String getTbkItem(String fields,String platform,String num_iids,String adzone_id) throws IOException {
